...
различные синтаксические конструкции языка С++. в стандарте каких годов были реализованы эти конструкции.
...
* 01 сохраняется цикл но без логики

* 02 цикл меняется на умножение
